...
import {QUERY_KEY, STATUS_CONFIG, STATE_PROJECT, SORT_TYPE, TYPE_ACCOUNT, TYPE_DATE} from '~/constants/config/enum';
...
function MainPageProject({}: PropsMainPageProject) {
	...
	const listProject = useQuery(
		[QUERY_KEY.table_list_user, _page, _pageSize, _state, _keyword, _status, _managerUuid, _userUuid, sort, from, to],
		{
			queryFn: () =>
				httpRequest({
